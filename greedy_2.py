...
parser.add_argument('--input', type=str, default='sample2.json')
...
def min_time_driver(cost_driver):
	min_time = min(cost_driver)
	return cost_driver.index(min_time)
...
if __name__ == '__main__':
	...
	while len(visited) <= n:
		dr = min_time_driver(cost_driver)
		add_next_node(dr)
